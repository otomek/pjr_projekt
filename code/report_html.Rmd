...
Jak pokazuje powyższe podsumowanie, zdecydowana liczba ataków była przeprowadzona przez mężczyzn.
...
Zdecydowanie przważają ataki celowe (*targeted*, czyli z checią zabicia konkretnych osób), oprócz tego jeszcze często zdarzały się przypadki określone jako *indiscriminate* (strzelanie bez konkretnych celów) i strzały przypadkowe (*accidental*). Te trzy typy strzelanin zostały wzięte do dalszej analizy.
